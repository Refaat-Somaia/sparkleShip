            ...
            Center(
              child: Column(
                children: [
                  ...
                  Text(
                    "Swipe",
                    style: setFontStyle(14.sp, FontWeight.w500, bodyColor),
                  ),
                ],
              ),
            ),
                          ...
                          child: Column(children: [
                            ...
                            Animate(
                              child: Image.asset(
                                ...
                                .animate()
                                .slideY(duration: 700.ms, begin: 0.3, end: 0)
              ...
              Positioned(
                ...
                child: Row(
                  children: [
                    SizedBox(width: 10.w),
                    circle(
                        index == 0 ? mainColor : const Color(0xFFD3E0EA), 2.h),
                    SizedBox(width: 2.5.w),
                    circle(
                        index == 1 ? mainColor : const Color(0xFFD3E0EA), 2.h),
                    SizedBox(width: 2.5.w),
                    circle(
                        index == 2 ? mainColor : const Color(0xFFD3E0EA), 2.h),
                    SizedBox(width: 2.5.w),
                    circle(
                        index == 3 ? mainColor : const Color(0xFFD3E0EA), 2.h),
                    SizedBox(width: 27.w),
                    Container(
                      width: 30.w,
                      height: 7.h,
