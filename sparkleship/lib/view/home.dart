                ...
                child: GNav(
                    ...
                    tabs: [
                      GButton(
                        ...
                        text: "Home",
                        textStyle:
                            setFontStyle(10.sp, FontWeight.w500, mainColor),
...
class _Home1 extends State<Home1> {
  ...
  getName() async {
    ...
    if (prefs.getString('userAge') != null &&
        prefs.getString('userAge') != '') {
      setState(() {
        isAccountSet = true;
      });
    }
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    ...
                                    child: Text(
                                      'Hello, $userName',
                                      style: setFontStyle(
                                          15.sp, FontWeight.w600, mainColor),
                                    ),
                                  ),
                                  Container(
                                    width: 12.w,
                                    ...
                                    child: Stack(
                                      children: [
                                        ...
                                        Positioned(
                                            child: circle(orangeColor, 1.5.h))
                                      ],
                                    ),
                                  ),
                                  SizedBox(
                                ...
                                child: SizedBox(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SingleChildScrollView(
                                        scrollDirection: Axis.horizontal,
                                        child: Row(children: listOfGroups),
                                      ),
                                    ],
                                  ),
                                ),
        ...
        children: [
          ...
          SizedBox(
            ...
            child: Text(
              department,
              style: setFontStyle(
                  9.sp, FontWeight.normal, const Color(0xFF6A9EB5)),
            ),
          ),
          TextButton(
            onPressed: () {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) => ScholarshipDetails(
                          scholarshipsList.elementAt(index))));
            },
            child: Text(
              'Show details',
  ...
  AssetImage imageOfGroup(String name) {
    return AssetImage(name == "Canada"
  ...
  Widget createGroup(String name, String depatrment, String count,
    ...
    return Container(
      ...
      height: 25.h,
      decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(12), color: bodySecond),
      child: TextButton(
        onPressed: () {
          Navigator.push(
              context,
              CupertinoPageRoute(
                  builder: (context) => ViewNewGroup(name, imageOfGroup(name),
                      int.parse(count), depatrment, description, id)));
        },
        child: Column(
          children: [
            SizedBox(height: 1.h),
            ...
            SizedBox(
                ...
                child: Center(
                  child: Text(
                    depatrment,
                    style: setFontStyle(
                        9.sp, FontWeight.w400, const Color(0xFF6A9EB5)),
                    textAlign: TextAlign.center,
  ...
  Future<void> fetchScholarships() async {
    ...
    url = Uri.parse("http://$serverIp:3000/api/scholarships");
    ...
    if (response.statusCode == 200) {
      ...
      for (int i = 0; i < scholarshipsList.length; i++) {
        setState(() {
          ...
          listOfScholarships.add(createScholarShip(
              scholarship["title"], scholarship['fieldOfStudy'], i));
        });
      }
    }
  }
  ...
  void getGroups() async {
    ...
    if (response.statusCode == 200) {
      ...
      for (int i = 0; i < groupsList.length; i++) {
        ...
        for (int j = 0; j < 5; j++) {
          if (prefs.getString("userGroups,$j").toString() ==
              group['name'].toString()) {
            isJoined = true;
          }
        }
